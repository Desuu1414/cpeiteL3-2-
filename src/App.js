...
export default function App() {
  ...
  const clickHandler = (e) => {
    ...
    switch(param) {
      ...
      case 'NAME':
        setDisp('SHERWIN AHRON SANTOS'); break;
      case 'What I learned?':
        setDisp('Programming, networking, teamwork'); break;
      case 'What I want to learn?':
        setDisp(' AI, cybersecurity, management'); break;
      case 'How will I learn?':
        setDisp('Practice, internships'); break;
      default:
  ...
  return (
    <div className="App">
      <div className="CalcContainer">
        <h1>SHERWIN AHRON SANTOS - IT3A</h1>
